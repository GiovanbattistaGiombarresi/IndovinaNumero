...
//    	this.txtRisultato.setText(Integer.toString(numeroSegreto));
    ...
    void doProva(ActionEvent event) {
        ...
        StatoGioco risultato= model.tentativo(guess);
